...
исходя из вычисленного периметра, разделяя его на 4, чтобы получить ширину и
высоту.
Подсказка № 5
...
# Если высота не указана, устанавливаем ее равной ширине
(создаем квадрат)
self.width = width
...
# Магический метод для вычитания одного прямоугольника из
другого
...
def __str__(self):
return f"Прямоугольник со сторонами {self.width} и
{self.height}"
